...
; 安装程序初始定义常量
!define PRODUCT_NAME "中国象棋对战"
!define PRODUCT_VERSION "1.0"
!define PRODUCT_PUBLISHER "邱维东"
...
Section "MainSection" SEC01
  ...
  CreateDirectory "$SMPROGRAMS\中国象棋对战"
  CreateShortCut "$SMPROGRAMS\中国象棋对战\中国象棋对战.lnk" "$INSTDIR\chess.exe"
  CreateShortCut "$DESKTOP\中国象棋对战.lnk" "$INSTDIR\chess.exe"
...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\中国象棋对战\Website.lnk" "$INSTDIR\${PRODUCT_NAME}.url"
  CreateShortCut "$SMPROGRAMS\中国象棋对战\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\中国象棋对战\Uninstall.lnk"
  Delete "$SMPROGRAMS\中国象棋对战\Website.lnk"
  Delete "$DESKTOP\中国象棋对战.lnk"
  Delete "$SMPROGRAMS\中国象棋对战\中国象棋对战.lnk"

  RMDir "$SMPROGRAMS\中国象棋对战"
  RMDir "$INSTDIR\"
