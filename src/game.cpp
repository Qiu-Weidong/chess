...
Game::Game() {
    ...
    turn_label_background_.setTextureRect(sf::IntRect(sf::IntRect(rand()%50*156, 0, 156, 156)));
    turn_label_background_.setOrigin(156 >> 1, 156 >> 1);
    int turn_label_left = (settings.panel_width_ >> 1);
    turn_label_background_.setPosition(window_width - settings.panel_width_ + turn_label_left, 
    ...
    turn_label_black_.setPosition(window_width - settings.panel_width_ + turn_label_left, 
        settings.turn_label_radius_ + 50);
    turn_label_red_.setPosition(window_width - settings.panel_width_ + turn_label_left, 
        settings.turn_label_radius_ + 50);
    ...
    river_.setColor(sf::Color::Black);
